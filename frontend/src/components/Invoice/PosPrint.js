				...
				<div className='pos-print-body'>
					...
					<table className='table'>
						...
						<tr className='subtotal'>
							...
							<td>{data.total_amount - (data.total_amount*(16/116)).toFixed(2)}</td>
						</tr>
						<tr className='vat'>
							<td></td>
							<td>VAT</td>
							<td></td>
							<td>{(data.total_amount*(16/116)).toFixed(2)}</td>
						</tr>
						...
						<tr className='total'>
							...
							<td>Total</td>
							<td></td>
							<td>Ksh {data.total_amount - data.discount}</td>
						</tr>
					</table>
					{invoiceData?.footer} <br />© Blist | 2023
				</div>
			</div>
		</Fragment>
	);
