				...
				<Row gutter={[24, 24]}>
					<Col span={24}>
						<div
							...
							<strong>Total: </strong>
							<strong>Ksh {totalDiscountPaidDue.total}</strong>
						</div>
						...
						<div
							...
							<strong>VAT: </strong>
							<strong>Ksh {(totalDiscountPaidDue.total * (16/116)).toFixed(2)}</strong>
						</div>
						...
						<div
							...
							<strong>Ksh {totalDiscountPaidDue.afterDiscount}</strong>
						</div>
						...
						<div
							...
							<strong>Ksh {totalDiscountPaidDue.due}</strong>
						</div>
					</Col>
